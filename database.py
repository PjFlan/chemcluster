        ...
        if os.path.isfile(comp_file) and not regen:
            ...
            for record in cursor:
                try:
                    ...
                    comp_tmp = record["FILTERED"][0]["orca"][0]["excited_states"][
                        "orbital_energy_list"
                    ]
                    lam_1, lam_2, lam_3 = (
                        comp_tmp[0]["amplitude"],
                        comp_tmp[1]["amplitude"],
                        comp_tmp[2]["amplitude"],
                    )
                    osc_1, osc_2, osc_3 = (
                        comp_tmp[0]["oscillator_strength"],
                        comp_tmp[1]["oscillator_strength"],
                        comp_tmp[2]["oscillator_strength"],
                    )
                except KeyError:
                    continue
                smiles.append(smi)
